...
double deltaT(int year, int month)
{
	...
	if (year < -500) {
		...
		u = y - 1600;
		return 120 + u * (-0.9808 + u * (- 0.01532 + u / 7129));
	} else if (year < 1800) {
		u = y - 1700;
		return 8.83 + u * (0.1603 +
		                   u * (-0.0059285 + u * (0.00013336 + u / -1174000)));
	} else if (year < 1860) {
		u = y - 1800;
		...
		return 7.62 + u * (0.5737 +
		                   u * (-0.251754 +
		                        u * (0.01680668 +
		                             u * (-0.0004473624 + u / 233174))));
	} else if (year < 1920) {
		u = y - 1900;
		return -2.79 + u * (1.494119 +
		                    u * (-0.0598939 + u * (0.0061966 + u * -0.000197)));
	} else if (year < 1941) {
		u = y - 1920;
		return 21.20 + u * (0.84493 +
		                    u * (-0.076100 + u * 0.0020936));
	} else if (year < 1961) {
		u = y - 1950;
